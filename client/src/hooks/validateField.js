...
export function validateField(value, field) {
  ...
  switch(field){
    ...
    case 'password':
        ...
        else if(!/^(?=.{8,})(?=.*[a-z])(?=.*[A-Z])(?=.*\d)[a-zA-Z0-9]*$/.test(value)) error = 'La contraseña debe contener una minúscula, una mayúscula y un numero.'
        break;
    ...
    case 'name':
        ...
        else if(!/^[A-Z][A-Za-z]{1,34}$/.test(value)) error = 'El nombre debe estar capitalizado y contener solo letras.'
        break;
    case 'last_name':
