    ...
    return (
      <div>
            ...
            <div id="pasajero">
              ...
              ? <div className={style.tripsBuy}>
                  ...
                  user.trips.map((t, i) => { //recorro los viajes del usuario y voy renderizandolos en ese div junto a Review
                    return <div className={style.tripCard} id="consuctor">
              ...
              : <p>No realizo viajes aún</p> //si reviews no existe entonces no muestro los viajes del usuario (necesito saber si hizo alguna reseña sí o sí)
              }
            </div>
          ...
          ? <div id="conductor">
              ...
              <span>Calificación: {user.driver.rating} ⭐</span>
              <h3>Autos</h3>
