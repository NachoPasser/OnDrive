...
const Testimonial = () => {
  return (
    <div
      ...
      style={{ position: 'absolute', display: "flex", justifyContent: "center", marginTop: 20, border:"6px solid #212734", backgroundColor:'#12192C', borderRadius:'40px', width:'600px', height:'500px', marginLeft:'30px'}}
    >
